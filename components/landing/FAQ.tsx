...
const faqs = [
  {
    ...
    a: 'Ні. Курс допомагає зрозуміти свою хворобу й краще виконувати призначення, але не змінює їх. Дозування ліків від тиску завжди погоджуйте зі своїм лікарем.',
  },
  {
    q: 'Кому підійде курс?',
    a: 'Усім, у кого тиск підвищений або на межі норми, і їхнім близьким. Уроки пояснюють, як працює тиск, і допомагають перестати боятися цифр на тонометрі.',
  },
  {
