...
const faqs = [
  ...
  },
  {
    ...
    a: 'Для всіх, хто живе з діабетом або переддіабетом, і для їхніх близьких. Уроки пояснюють, як працюють цукор та інсулін, і допомагають перестати боятися цифр.',
  },
  {
