...
const faqs = [
  {
    ...
    a: 'Ні. Курс допомагає зрозуміти свою хворобу й краще виконувати призначення, але не змінює їх. Знеболювальні та інші ліки завжди погоджуйте зі своїм лікарем.',
  },
  {
    q: 'Кому підійде курс?',
    a: 'Усім, хто живе з болем у спині, шиї, суглобах чи з частими головними болями, і їхнім близьким. Уроки пояснюють, як працює біль, і допомагають повернутися до руху без страху.',
  },
  {
  ...
  },
  {
    ...
    a: 'Ні, уроки доступні лише для перегляду на сайті. Так ми захищаємо працю авторки і тримаємо ціну доступною.',
  },
  {
